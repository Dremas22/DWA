...
// function createPreviewFragment(books) {
//     const fragment = document.createDocumentFragment();
...
// }
// extracted = books.slice(0, 36);
// fragment = createPreviewFragment(extracted);
// listItems.appendChild(fragment);
...
function createOptionsFragment(data, parentElement) {
    const fragment = document.createDocumentFragment();
    let element = document.createElement('option');
    element.value = 'any';
    element.innerText = `All ${parentElement.dataset.search}`;
    fragment.appendChild(element);
...
createOptionsFragment(genres, document.querySelector('[data-search-genres]'));
createOptionsFragment(authors, document.querySelector('[data-search-authors]'));
...
// listBtn.addEventListener('click', handleListBtnClick);
